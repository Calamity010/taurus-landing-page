...
const stats = [
  { icon: Video, value: 224087, label: 'Interviews completed', suffix: '' },
  { icon: Star, value: 4.6, label: 'Candidate experience rating', suffix: '/5' },
  { icon: Clock, value: 1120436, label: 'HR manhours saved', suffix: '' },
];
...
function StatCard({ stat, isVisible }: { stat: typeof stats[0]; isVisible: boolean }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl shadow-soft p-8 text-center hover:shadow-soft-lg transition-shadow"
    >
